...
if(l == 1 && ny == 1 && nu == 1)
    ...
    reg2=u_tx1(1:(m-1)); % u(k-1)
    reg3=y_tx1(1:(m-1)); % y(k-1)
    psi=[reg1 reg2 reg3];
...
if(l == 1 && ny == 2 && nu == 1)
    ...
    reg2=u_tx1(2:(m-1)); % u(k-1)
    reg3=y_tx1(2:(m-1)); % y(k-1)
    reg4=y_tx1(1:(m-2)); % y(k-2)
...
if(l == 1 && ny == 1 && nu == 2)
    reg1=ones((m-2),1); % constante
    reg2=u_tx1(2:(m-1)); % u(k-1)
    reg3=u_tx1(1:(m-2)); % u(k-2)
    reg4=y_tx1(2:(m-1)); % y(k-1)
    psi=[reg1 reg2 reg3 reg4];
...
if(l == 3 && ny == 3 && nu == 3)
    ...
    psi=[psi reg74 reg75 reg76 reg77 reg78 reg79 reg80 reg81 reg82 reg83 reg84];
        ...
        Regressores = {'1'; 'u_est(k-1)'; 'u_est(k-2)'; ...
    'u_est(k-3)'; 'y_est(k-1)'; 'y_est(k-2)'; 'y_est(k-3)'; 'u_est(k-1)^2'; ...
    'u_est(k-1)*u_est(k-2)'; 'u_est(k-1)*u_est(k-3)'; 'u_est(k-2).^2'; ...
    'u_est(k-2)*u_est(k-3)'; 'u_est(k-3).^2'; ...
    'y_est(k-1)*u_est(k-1)'; ...
    'y_est(k-1)*u_est(k-2)'; ...
    'y_est(k-1)*u_est(k-3)'; ...
    'y_est(k-2)*u_est(k-1)'; ...
    ...
    'u_est(k-1).^3'; ...
    'u_est(k-1).^2*u_est(k-2)'; ...
    'u_est(k-1).^2*u_est(k-3)'; ...
    'u_est(k-1)*u_est(k-2).^2'; ...
    'u_est(k-1)*u_est(k-2)*u_est(k-3)'; ...
    'u_est(k-1)*u_est(k-3).^2'; ...
    'u_est(k-2).^3'; ...
    'u_est(k-2).^2*u_est(k-3)'; ...
    'u_est(k-2)*u_est(k-3).^2'; ...
    'u_est(k-3).^3'; ...
    'y_est(k-1)*u_est(k-1).^2'; ...
    'y_est(k-1)*u_est(k-1)*u_est(k-2)'; ...
    ...
    'y_est(k-1).^2*u_est(k-1)'; ...
    'y_est(k-1).^2*u_est(k-2)'; ...
    'y_est(k-1).^2*u_est(k-3)'; ...
    'y_est(k-1)*y_est(k-2)*u_est(k-1)'; ...
    'y_est(k-1)*y_est(k-2)*u_est(k-2)'; ...
    'y_est(k-1)*y_est(k-2)*u_est(k-3)'; ...
    'y_est(k-1)*y_est(k-3)*u_est(k-1)'; ...
    'y_est(k-1)*y_est(k-3)*u_est(k-2)'; ...
    'y_est(k-1)*y_est(k-3)*u_est(k-3)'; ...
    'y_est(k-2).^2*u_est(k-1)'; ...
    'y_est(k-2).^2*u_est(k-2)'; ...
    'y_est(k-2).^2*u_est(k-3)'; ...
    'y_est(k-2)*y_est(k-3)*u_est(k-1)'; ...
    'y_est(k-2)*y_est(k-3)*u_est(k-2)'; ...
    'y_est(k-2)*y_est(k-3)*u_est(k-3)'; ...
    'y_est(k-3).^2*u_est(k-1)'; ...
    'y_est(k-3).^2*u_est(k-2)'; ...
    'y_est(k-3).^2*u_est(k-3)'; ...
    'y_est(k-1).^3'; ...
    'y_est(k-1).^2*y_est(k-2)'; ...
    'y_est(k-1).^2*y_est(k-3)'; ...
    'y_est(k-1)*y_est(k-2).^2'; ...
    'y_est(k-1)*y_est(k-2)*y_est(k-3)'; ...
    'y_est(k-1)*y_est(k-3).^2'; ...
    'y_est(k-2).^3'; ...
    'y_est(k-2).^2*y_est(k-3)'; ...
    'y_est(k-2)*y_est(k-3).^2'; ...
    'y_est(k-3).^3'};
end